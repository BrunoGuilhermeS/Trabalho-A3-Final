...
<nav class="sidebar">
    ...
    <div class="content-area">
        <div class="users-menu">
            ...
            <div class="criarUsuarioScreen" id="criarUsuarioScreen">
                <form class="form-op" action="gerenciar_usuarios_crud.php" method="post">
                    <label for="novousuario" class="form-label">Suporte:
                        <input type="text" class="form-control" id="novousuario" name="novousuario" placeholder="">
                    </label>
                    ...
                    <div class="form-buttons">
                        <button type="submit" id="criarUsuarioButton" name="criarUsuario" class="submit-button">Criar
                            Usuário</button>
                    </div>
                </form>
            </div>
